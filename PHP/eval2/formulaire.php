...
$resultat = $pdo -> prepare("INSERT INTO annuaire (nom, prenom, telephone, profession, ville, cp, adresse, date_de_naissance, sexe, message") VALUES (":nom, :prenom, :telephone, :profession, :ville, :cp, :adresse, :date_de_naissance, :sexe, :message");
...
<html lang="fr">
    ...
    <body>
        ...
        <form action="" method="post">
            ...
            <input name="telephone" type="text"></input><br><br>
            ...
            <textarea style="rezise:none" name="adresse" rows="3" cols="22"></textarea><br><br>
