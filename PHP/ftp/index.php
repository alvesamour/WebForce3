...
$pdo = new PDO('mysql:host=localhost;dbname=id3141814_sara', 'id3141814_sara', 'forever1994', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
