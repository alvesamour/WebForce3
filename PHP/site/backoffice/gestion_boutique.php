...
foreach ($produits as $valeur) { // parcourt tous les enregistrement
    $contenu .= "<tr>"; // ligne pour chaque enregistrement
        ...
        $contenu .= '<td><a onclick="confirm(\'Etes-vous certain de vouloir supprimer ce produit' . $valeur['id_produit'] . '\');" href="supprimer_produit.php?id=' . $valeur['id_produit'] . '"><img src="../img/delete.png"></a></td>';
