        ...
        <header>
			<div class="conteneur">
                ...
                <?php endif; ?>
					...
					<a class="<?= ($page =='Panier') ? 'active' : '' ?>"href="<?= RACINE_SITE ?>panier.php">Panier<?php if(quantitePanier()) : ?></a><span class="bulle"><?= quantitePanier() ?></span><?php endif; ?></a>
                <?php if(userAdmin()) : ?>
                    ...
                    <a class="<?= ($page =='Gestion Boutiques') ? 'active' : '' ?>"href="<?= RACINE_SITE ?>backoffice/gestion_commandes.php">Gestion Commandes</a>
                <?php endif; ?>
